...
public class TrapProfile extends Profile {
    private final double distance , max_velocity, acceleration, t0, t1, t2, t3, start_velocity, end_velocity, d1, d2, d3; 
	
    public TrapProfile(final double v_max, final double accel, final double dist, final double start_vel, final double end_vel){
        distance = dist;
        max_velocity = v_max;
        acceleration = accel;
