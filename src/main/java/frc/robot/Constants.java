...
public final class Constants {
    ...
    public final static double CLIMBER_SPEED = 0.3;
    ...
    public final static int DRIVEBASE_FRONT_LEFT_ID = 1;
    public final static boolean DRIVEBASE_FRONT_LEFT_INVERTED = false;

    public final static int DRIVEBASE_FRONT_RIGHT_ID = 2;
    public final static boolean DRIVEBASE_FRONT_RIGHT_INVERTED = false;

    public final static int DRIVEBASE_BACK_LEFT_ID = 3;
    ...
    public final static int CLIMBER_LEFT_ID = 5;
    public final static boolean CLIMBER_LEFT_INVERTED = false;

    public final static int CLIMBER_RIGHT_ID = 6;
    public final static boolean CLIMBER_RIGHT_INVERTED = false;

    public final static int ARM_PIVOT_ID = 7;
    ...
    public final static int ELEVATOR_FRONT_LEFT_ID = 9;
    public final static boolean ELEVATOR_FRONT_LEFT_INVERTED = false;

    public final static int ELEVATOR_FRONT_RIGHT_ID = 10;
    public final static boolean ELEVATOR_FRONT_RIGHT_INVERTED = false;
    
    public final static int ELEVATOR_BACK_LEFT_ID = 11;
    public final static boolean ELEVATOR_BACK_LEFT_INVERTED = false;

    public final static int ELEVATOR_BACK_RIGHT_ID = 12;
    public final static boolean ELEVATOR_BACK_RIGHT_INVERTED = false;
}